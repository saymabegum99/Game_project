...
transform moving_target02:
    ...
    ## target is off centre 100% of the time.
    xpos 0
    ypos 200
...
label begin_hunt02:
    ...
    while shots_fired02 < 3:
        ...
        call hunting02 from _call_hunting02
        ...
        if _return: # Good result
            ...
            $ renpy.show ('', at_list=[mark02(shots_fired02)], layer='master', what=Solid('#00FF00', xsize=24, ysize=24), zorder=50, tag='mark02%d'%shots_fired02)

        else:       # bad result
            $ renpy.show ('', at_list=[mark02(shots_fired02)], layer='master', what=Solid('#FF0000', xsize=24, ysize=24), zorder=50, tag='mark02%d'%shots_fired02)
