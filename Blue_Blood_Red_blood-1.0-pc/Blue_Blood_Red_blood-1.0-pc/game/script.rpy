...
label start:
    ...
    label gun1:
        ...
        scene battlefield_101
        call begin_hunt01 from _call_begin_hunt01
    ...
    scene hospital_bed
    play music "<loop 6.333>sounds/Haunted_mp3.mp3"
    with Fade(2, 1, 6)
   ...
   ##multiple choice, there are two choices a user can pick.
    ...
    play music "<loop 6.333>sounds/Heart_beat_mp3.mp3"
    ...
    play music "<loop 6.333>sounds/Ambient_hope_mp3.mp3"
...
## Chapter 3- Joining the army.
    ...
    kiril talk "Didn't know you were so eager to?"
...
## choice between food
    ...
    play music "<loop 6.333>sounds/newbeat.mp3"
    scene library
    with dissolve
    ...
    vladimir_1 "Now tell me, what's you name?"

    kiril talk "Kiril Mahadov Sir, and this is Kolya. Kolya Smirnov."

    vladimir1 "I see. Does he always make you talk for him then?"

    vladimir_1 "Quiet as a mouse, perhaps he'll make a decent spy..."

    kiril talk "Yes , well, we'll be on our way then, if that's all right."
    ...
    kolya "You saw that day and you failed to do anything about it!"

    kiril "I know... I'll never forgive myself."
    ...
    ##CHAPTER 4
    play music "<loop 6.333>sounds/despair.mp3"
    scene bed
    with Fade(2, 1, 6)
...
## the user cannot move forward until they find an image of his clothes.
    ...
    play music "<loop 1.00>sounds/newbeat.mp3"
   ...
   ## choice to see if the user was paying attention to the text
    ...
    play music "<loop 1.00>sounds/Ambient_hope_mp3.mp3"
    scene dorm
    with Fade(2, 1, 6)
    ...
    play music "<loop 1.00>sounds/Ambient_Joy_mp3.mp3"
    ...
    label gun2:
        scene battlefield_old
        call begin_hunt02 from _call_begin_hunt02
        if _return > 0: # This is a special variable returned from the last call
    ...
    menu:
        ...
        "Shoot at Kiril":
            play sound "sounds/gun_sound.mp3"
            $ kiril_points -= 1;
            $ renpy.notify ("Kiril's affection -1!")
    ...
    play music "<loop 1.00>sounds/Heart_beat_mp3.mp3"
    ...
    play music "<loop 1.00>sounds/despair.mp3"
    ...
    label gun3:
        scene battlefield_night
        call begin_hunt03 from _call_begin_hunt03
        if _return > 0: # This is a special variable returned from the last call
...
## choice between times, correct answer gives you +1 point
    ...
    play music "<loop 1.00>sounds/Army_training_mp3.mp3"
    ...
    label gun4:
        scene battlefield_old
        call begin_hunt04 from _call_begin_hunt04
        if _return > 0:
            kolya "Thank God!"
            scene black with dissolve
    ...
    play music "<loop 1.00>sounds/Army_Training1_mp3.mp3"
    scene brick_wall
    with dissolve
    ...
    vladimir_1 "Now let's see, it's only fair that I pick the 2nd is it not?"

    vladimir_1 "Oh why would you look at that! Two peas in a pod"

    vladimir_1 "Get your pet dog and yourself up onto the ring Mahadov. Now!"
    ...
    kiril "I'm surprised they're not looking for you. They really ought to, your
    ...
    kolya "I always get a sickly moment of dread whenever that happens. This could be my
    ...
    kolya "Right, you're head looks awful though. I'll get something to cool it off."
    ...
    kolya "You're right. The Sergant had been so preoccupied lately and every
    ...
    kolya "I don't want your image of me to be any different when I die."
    ...
    label gun5:
        scene forest_walk
        call begin_hunt05 from _call_begin_hunt05
        if _return > 0: # This is a special variable returned from the last call
   ...
   #$ secret_pass1_1 = "sergei"
    ...
    play music "<loop 1.00>sounds/beat_song.mp3"
    ...
    label gun6:
        scene forest_war_game
        call begin_hunt05 from _call_begin_hunt05_1
        if _return > 0:
   ...
   ##GUN GAME AGAIN, MOVING Targets
    ...
    label gun7:
        scene forest_war_game
        call begin_hunt05 from _call_begin_hunt05_2
        if _return > 0:
            kolya "Kiril!"
            scene black with dissolve
    ...
    label gun8:
        ...
        scene battlefield_101
        call begin_hunt01 from _call_begin_hunt01_1
        if _return > 0: # This is a special variable returned from the last call
    ...
    ##CENSORSHIP IN RUSSIA FACT CARD
