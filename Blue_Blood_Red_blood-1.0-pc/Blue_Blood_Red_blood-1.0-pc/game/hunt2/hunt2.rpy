...
label begin_hunt03:
    ...
    while shots_fired03 < 1:
        ...
        call hunting03 from _call_hunting03
        ...
        if _return: # Good result
            $ targets_hit03 += 1
            $ renpy.show ('', at_list=[mark03(shots_fired03)], layer='master', what=Solid('#00FF00', xsize=24, ysize=24), zorder=50, tag='mark03%d'%shots_fired03)

        else:       # bad result
            $ renpy.show ('', at_list=[mark03(shots_fired03)], layer='master', what=Solid('#FF0000', xsize=24, ysize=24), zorder=50, tag='mark03%d'%shots_fired03)
