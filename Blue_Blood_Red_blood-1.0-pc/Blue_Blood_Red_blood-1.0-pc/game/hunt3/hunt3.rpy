...
label begin_hunt04:
    ...
    while shots_fired04 < 3:
        ...
        call hunting04 from _call_hunting04
        ...
        if _return: # Good result
            $ targets_hit04 += 1
            $ renpy.show ('', at_list=[mark04(shots_fired04)], layer='master', what=Solid('#00FF00', xsize=24, ysize=24), zorder=50, tag='mark04%d'%shots_fired04)

        else:       # bad result
            $ renpy.show ('', at_list=[mark04(shots_fired04)], layer='master', what=Solid('#FF0000', xsize=24, ysize=24), zorder=50, tag='mark04%d'%shots_fired04)
