...
label begin_hunt05:
    ...
    while shots_fired05 < 3:
        ...
        call hunting05 from _call_hunting05
        ...
        if _return: # Good result
            $ targets_hit05 += 1
            $ renpy.show ('', at_list=[mark05(shots_fired05)], layer='master', what=Solid('#00FF00', xsize=24, ysize=24), zorder=50, tag='mark05%d'%shots_fired05)

        else:       # bad result
            $ renpy.show ('', at_list=[mark05(shots_fired05)], layer='master', what=Solid('#FF0000', xsize=24, ysize=24), zorder=50, tag='mark05%d'%shots_fired05)
